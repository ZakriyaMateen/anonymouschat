...
class TemporaryShowingImage extends StatefulWidget {
  final File?image;
  final String uid;
  final String groupName;
  final String isAdmin;
  const TemporaryShowingImage({Key? key, this.image, required this.uid, required this.groupName, required this.isAdmin}) : super(key: key);

  @override
  State<TemporaryShowingImage> createState() => _TemporaryShowingImageState();
}

class _TemporaryShowingImageState extends State<TemporaryShowingImage> {
